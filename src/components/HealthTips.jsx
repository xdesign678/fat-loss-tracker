...
const HealthTips = () => {
  ...
  const badgeStyle = (level) => ({
    ...
    fontWeight: '600',
    marginRight: '8px',
    background: level === 'A' ? 'var(--success-alt)' : level === 'B' ? 'var(--accent)' : 'var(--text-muted)',
    color: '#ffffff'
  });
  ...
  const jointFriendlyStyle = (level) => ({
    ...
    fontWeight: '600',
    marginLeft: '8px',
    background: level === 'high' ? 'var(--success-alt)' : level === 'medium' ? 'var(--warning)' : 'var(--danger)',
    color: '#ffffff'
  });
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '1000px', margin: '0 auto' }}>
      <div style={{ marginBottom: '32px' }}>
        <h1 style={{ fontSize: '2.5em', fontWeight: '700', color: 'var(--text-heading)', marginBottom: '8px' }}>
          健康知识库
        </h1>
      ...
      <div style={sectionStyle}>
        <div style={headerStyle} onClick={() => toggleSection('diet')}>
          <Utensils size={28} color="var(--success-alt)" />
      ...
      <div style={sectionStyle}>
        <div style={headerStyle} onClick={() => toggleSection('sleep')}>
          <Moon size={28} color="var(--accent-secondary)" />
      ...
      <div style={sectionStyle}>
        <div style={headerStyle} onClick={() => toggleSection('supplements')}>
          <Pill size={28} color="var(--accent-secondary)" />
        ...
        {openSections.medical && (
          <div>
            <div style={{ marginBottom: '24px' }}>
              <h3 style={{ color: 'var(--warning)', fontSize: '1.2em', marginBottom: '12px' }}>
                减脂前必做检查
              </h3>
              <div style={listItemStyle}>
                <span style={warningIconStyle}>⚠</span>
            ...
            <div>
              <h3 style={{ color: 'var(--danger)', fontSize: '1.2em', marginBottom: '12px' }}>
                立即就医信号
              </h3>
              <div style={listItemStyle}>
      ...
      <div style={sectionStyle}>
        ...
        {openSections.myths && (
          <div>
            <div style={{ ...supplementItemStyle, borderLeft: '4px solid var(--danger)' }}>
              <div style={{ color: 'var(--danger)', fontWeight: '600', marginBottom: '8px' }}>
                ❌ 误区：节食越狠瘦得越快
              </div>
              <div style={{ color: 'var(--success-alt)', fontWeight: '600', marginBottom: '4px' }}>
                ✓ 真相：
              </div>
