...
const Dashboard = ({ selectedDate, onDateChange, onOpenWeightLogger }) => {
  ...
  const styles = {
    ...
    greeting: { fontSize: 'var(--text-4xl)', fontWeight: '700', color: 'var(--text-heading)' },
    ...
    statValue: { fontSize: 'var(--text-3xl)', fontWeight: '700', marginBottom: 'var(--space-xs)' },
    ...
    actionButton: { padding: '6px var(--space-md)', fontSize: 'var(--text-sm)', borderRadius: 'var(--radius-base)', border: '1px solid var(--accent)', cursor: 'pointer', background: 'transparent', color: 'var(--accent)', transition: 'all 0.2s' },
    tipCard: { background: 'rgba(34, 197, 94, 0.05)', border: '1px solid rgba(34, 197, 94, 0.15)', borderRadius: 'var(--radius-xl)', padding: 'var(--space-lg)', display: 'flex', gap: 'var(--space-md)' },
    tipIcon: { color: 'rgba(34, 197, 94, 0.6)', flexShrink: 0 },
    tipContent: { flex: 1 },
    tipTitle: { fontSize: 'var(--text-base)', fontWeight: '600', color: 'rgba(34, 197, 94, 0.85)', marginBottom: '8px' },
