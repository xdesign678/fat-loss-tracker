...
const Dashboard = ({ selectedDate, onDateChange }) => {
  ...
  const styles = {
    ...
    actionButton: { padding: '6px var(--space-md)', fontSize: 'var(--text-sm)', borderRadius: '7.5px', border: '1px solid var(--border)', cursor: 'pointer', background: 'transparent', color: 'var(--text-primary)', transition: 'all 200ms ease' },
